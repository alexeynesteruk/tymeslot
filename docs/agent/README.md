# My Paw Trainer Scheduler Agent Documents

This directory contains the implementation contract for the My Paw Trainer
Tymeslot fork.

## Documents

- `REQUIREMENTS.md`: required behavior, security invariants, boundaries, and
  acceptance criteria.
- `IMPLEMENTATION_PLAN.md`: dependency-ordered implementation and release plan.
- `STATUS.md`: verified repository, toolchain, VM, and execution state.
